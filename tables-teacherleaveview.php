                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Student Leave Application</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<div class="col-lg-12">
                <div class="card">
					<!--<div class="card-header">
						<strong class="card-title">Leave View</strong>
					</div>-->
					...
					<div class="table-stats order-table ov-h" id="student">
						<table class="table ">
							...
							$a=$_SESSION['tid'];
							$slno=1;
							$q="SELECT * FROM `leave` WHERE TeacherApproval='0'";
							$res=mysql_query($q);
							...
							?>
								...
								<tbody>
									<tr>
										...
										<td>  <span class="name"><?php $cid=$arr1['FkCID']; $res1=mysql_query("select * from course where CID='$cid'");
										$arr2=mysql_fetch_array($res1); echo $arr2['Course'];?></span> </td>
										...
										<td>
											<button type="button" class="btn btn-outline-success btn-sm" onClick="window.location.href='action-teacherleaveview.php?lid=<?php echo $arr['LID'];?>'"><i class="ti-pencil"></i>&nbsp; Approve</button>
										</td>
									</tr>
								</tbody><?php
							}?>
