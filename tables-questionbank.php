                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/student/photo/<?php $res7=mysql_query($q); $arr7=mysql_fetch_array($res7); echo $arr7['Photo'];?>" alt="User Avatar">
                        </a>
                    ...
                    <div class="card">
                       <!-- <div class="card-header">
                        ...
                        <div class="card-body">
							...
							$cid=$arr['FkCID'];
							$sem=$arr['Sem'];
							$q1="select * from questionbank where FkCID='$cid' and Sem='$sem'";
							$res1=mysql_query($q1);
							...
							?>
                                <tbody>
                                    <tr>
                                        <th scope="row"><?php echo $arr1['QID'];?></th>
                                        <td><?php $pap=$arr1['FkPID']; $res4=mysql_query("select * from paper where PID='$pap'"); $arr4=mysql_fetch_array($res4); echo $arr4['Papername'];?></td>
                                        <td><?php echo date('d-m-Y',strtotime ($arr1['Year']));?></td>
                                        <td><a href="images/questionpapers/<?php echo $arr1['Questionpaper'];?>">Download <i class="ti-arrow-down"></a></td>
                                    </tr>
									<?php } ?>
