...
<body>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Notes Upload</li>
                                </ol>
                            </div>
                        </div>
                    </div>
		...
		<form method="post" action="action-notesupload.php" enctype="multipart/form-data">
        <div class="content">
                    ...
                    <div class="col-xs-6 col-sm-12">
                        <div class="card">
                            <!--<div class="card-header">
                                <strong class="card-title">Notes Upload</strong>
                            </div>-->
                            <div class="card-body">

							<div class="row form-group">
								<div class="col col-md-1"><label class=" form-control-label">Course</label></div>
								<div class="col-6 col-md-3">
								  <select data-placeholder="course" class="form-control" tabindex="1" name="course">
									<option value="" label="default"></option>
									<option value="1">BCA</option>
									<option value="2">Bsc Computer Science</option>
									<!--<option value="physics">Bsc Physics</option>
									<option value="ca">Bcom CA</option>
									<option value="cop">Bcom Coperation</option>
									<option value="genaral">BBA General</option>
									<option value="ttm">BBA TTM</option>
									<option value="mcom">Mcom</option>
									<option value="mscphysics">Msc Physics</option>-->
								 </select>
								</div>
							</div>
								<div class="row form-group">
								<div class="col col-md-1"><label class=" form-control-label">Semester</label></div>
								<div class="col col-lg-3">
                              <select data-placeholder="Sem" class="form-control" tabindex="1" name="sem">
                                <option value="" label="default"></option>
								...
								<div class="row form-group">
                                        <div class="col col-md-1"><label for="text-input" class=" form-control-label">Papername</label></div>
										<div class="col col-lg-3"><input type="text" name="papername" class="form-control"></div>
								</div>
								<div class="row form-group">
                                        <div class="col col-md-1"><label for="file-input" class=" form-control-label">Description</label></div>
										<div class="col col-lg-3"><input type="text" name="description" class="form-control"></div>
								</div>
										
								<div class="row form-group">
                                        <div class="col col-md-1"><label for="file-input" class=" form-control-label">Note</label></div>
                                        <div class="col col-lg-3"><input type="file" id="note" name="note" class="form-control-file"></div>
                                    </div>
