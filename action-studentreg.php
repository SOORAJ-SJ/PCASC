...
else
{
	...
	$q="insert into studentdetails(Firstname,Lastname,Dob,Gender,Religion,Caste,Email,Phone,Address,Plustwo,Sslc,Photo,FkCID,Sem,Secondlang,Yearofjoining,Semstartdate) values('$fname','$lname','$dob','$gen','$religion','$caste','$email','$phone','$address','$plustwo','$sslc','$photo','$course','$sem','$scndlang','$year','$cdate')";
	$res=mysql_query($q);
	if($res)
	{
		$q1="select * from studentdetails where Firstname='$fname' and Lastname='$lname'";
		$res1=mysql_query($q1);
		...
		if($arr1)
		{
			mysql_query("update studentdetails set Username='$uname',Password='$dob' where Firstname='$fname' and Lastname='$lname'");
		}
		?><!--<script>alert("Uploaded Successfully");window.location.href="forms-studentreg.php"</script>-->
		<div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
			<span class="badge badge-pill badge-success">Success</span>
			You successfully uploaded..
			<button type="button" class="close" data-dismiss="alert" aria-label="Close" onClick="window.location.href='forms-studentreg.php'">
