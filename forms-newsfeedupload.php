...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>
	 ...
	 {
		 alert("executed");
		 if(document.form1.exdate.value<date('d-m-Y'))
		 {
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="#">Home</a></li>
                                    <li class="active">News Feed Upload</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                   ...
                   <div class="col-xs-6 col-sm-12">
                        <div class="card">
                            <!--<div class="card-header">
                                <strong class="card-title">News Feed Upload</strong>
                            </div>-->
							<form action="action-newsfeedupload.php" method="post">
                            <div class="card-body card-block">
								<div class="row form-group">
									<div class="col col-md-1"><label for="date-input" class=" form-control-label">Expiry Date</label></div>
									<div class="col-6 col-md-3"><input type="date" id="date" name="exdate" class="form-control"></div>
								</div>
								
								<div class="row form-group">
                                        <div class="col col-md-1"><label for="textarea-input" class=" form-control-label">Notification</label></div>
                                        <div class="col-6 col-md-3"><textarea name="notification" id="textarea-input" rows="4" placeholder="News feed..." class="form-control"></textarea></div>
                                    </div>	
								<div class="row form-group">
									<div class="col col-md-1"><label class=" form-control-label">To</label></div>
								<div class="col-6 col-md-3">
									  <select data-placeholder="select" class="form-control" name="to" id="to" tabindex="1" onChange="showPaper(this.value)">
