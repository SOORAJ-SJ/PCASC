<?php
	...
	if(!isset($_SESSION['tid']))
	{
		...
		$did=$arr['FkDID'];
		$res1=mysql_query("select * from department where DID='$did'");
                ...
                <div class="header-menu">
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="message" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<?php
									$tq3=mysql_query("select * from newsfeed");
									while($tres1=mysql_fetch_array($tq3))
									{
									$tnid=$tres1['NeID'];
									if($tres1['Expdate']== date('Y-m-d')||$tres1['Expdate']<date('Y-m-d'))
										mysql_query("delete from newsfeed where NeID='$tnid'");
									}
									$tq3=mysql_query("select * from newsfeed where Recipient='all' or Recipient='teach'");
									$tcount=mysql_num_rows($tq3);
									?>
                                <span class="count bg-primary"><?php echo $tcount; ?></span>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="message">
                                <p class="red">You have <?php echo $tcount; ?> Notification</p>
								<?php while($tres1=mysql_fetch_array($tq3)){ ?>
                                <a class="dropdown-item media" href="#">
									...
									<div class="message media-body">
                                        ...
                                        <span class="time float-right"><?php echo date('d-m-Y',strtotime ($tres1['Date'])); ?></span>
                                        <p><?php echo $tres1['Notification']; ?></p> 
									</div>	
                                </a>
								<?php } ?>
                            </div>
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/teacher/photo/<?php echo $arr['Photo'];?>" alt="User Avatar">
                        </a>
                            ...
                            <div class="card-body">
								<?php
									if($res)
									{
										?>
                                <div class="mx-auto d-block">
                                    <img class="rounded-circle mx-auto d-block" src="images/teacher/photo/<?php echo $arr['Photo'];?>" alt="Card image cap">
                                    <h5 class="text-sm-center mt-2 mb-1"><?php echo $arr['Firstname'];?></h5>
                                ...
                                <hr>
                                 ...
                                 <div class="card-body card-block">
									...
									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-3"><label for="text-input" class=" form-control-label"><b><?php echo $arr1['DeptName'];?></b></label> </div>
                                	</div>
