                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/student/photo/<?php $res7=mysql_query("select * from studentdetails where SID='$a'"); $arr7=mysql_fetch_array($res7); echo $arr7['Photo'];?>" alt="User Avatar">
                        </a>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
							...
							$cid=$arr['FkCID'];
							$sem=$arr['Sem'];
							$q1="select * from notes where FkCID='$cid' and Sem='$sem'";
							$res1=mysql_query($q1);
							...
							?>
                                <tbody>
                                    <tr>
                                        <th scope="row"><?php echo $arr1['NID'];?></th>
                                        <td><?php echo $arr1['Papername'];?></td>
                                        <td><?php echo $arr1['Description'];?></td>
                                        <td><a href="images/<?php echo $arr1['File'];?>">Download <i class="ti-arrow-down"></a></td>
                                    </tr>
									<?php } ?>
