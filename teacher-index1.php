                ...
                <ul class="nav navbar-nav">
                    ...
                    <!-- <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                           <li><i class="fa fa-table"></i><a href="tables-studentview.php">Student View</a></li>
                        </ul>
                    </li>-->
                    <li class="menu-item-has-children active dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Forms</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-attendanceentry.php">Attendance Entry</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-internalmark.php">Internal Mark Entry</a></li>
						   <li><i class="menu-icon fa fa-th"></i><a href="forms-studentreg.php">Student Registration</a></li>
						   <li><i class="menu-icon fa fa-th"></i><a href="forms-notesupload.php">Notes Upload</a></li>
                        </ul>
                    </li>
