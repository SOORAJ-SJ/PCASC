<?php
	...
	if(!isset($_SESSION['adid']))
	{
		...
		$a=$_SESSION['adid'];
		$q="select * from admindetails where AdID='$a'";
		$res=mysql_query($q);
                            ...
                            <div class="card-body">
								<?php
									if($res)
									{
										?>
                                <div class="mx-auto d-block">
                                    <img class="rounded-circle mx-auto d-block" src="images/avatar/4.jpg" alt="Card image cap">
                                    <h5 class="text-sm-center mt-2 mb-1"><?php echo $arr['Name'];?></h5>
                                   <!-- <div class="location text-sm-center"> <?php echo $arr['Dob'];?></div>
                                </div>
                                <hr>
                                 ...
                                 <div class="card-body card-block">
									...
									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-3"><label for="text-input" class=" form-control-label"><b><?php echo $arr['FkDID'];?></b></label> </div>
                                	</div>-->
