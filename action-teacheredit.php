...
else
{
	...
	$q=mysql_query("update teacherdetails set Firstname='$fname',Lastname='$lname',Dob='$dob',Gender='$gen',Religion='$religion',Caste='$caste',Email='$email',Phone='$phone',Address='$address',FkDID='$department' where TID='$tid'");
	if($q)
	{
		...
		<div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
			...
			<button type="button" class="close" data-dismiss="alert" aria-label="Close" onClick="window.location.href='tables-teacherdetailsview.php';">
	...
	else
	{
		...
		<div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
			...
			Unsuccessfull!!
			<button type="button" class="close" data-dismiss="alert" aria-label="Close" onClick="window.location.href='forms-teacheredit.php?tid=<?php echo $tid;?>';">
				<span aria-hidden="true">&times;</span>
			</button>
		</div><?php
	}
