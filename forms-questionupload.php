                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="#">Home</a></li>
                                    <li class="active">Question Bank Upload</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
function showPaper(sem) {
  ...
  if (sem=="") {
    document.getElementById("qpaper").innerHTML="";
    return;
  }
  ...
  xmlhttp.onreadystatechange=function() {
    if (this.readyState==4 && this.status==200) {
      document.getElementById("qpaper").innerHTML=this.responseText;
    }
  }
  xmlhttp.open("GET","getqpaper.php?sem="+sem+"&crs="+crs,true);
  xmlhttp.send();
}
</script>
                   ...
                   <div class="col-xs-6 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
								<form method="post" action="action-questionupload.php" enctype="multipart/form-data">
								<div class="row form-group">
									...
									<div class="col-6 col-md-3">
                              			<select data-placeholder="select" id="crs" name="course" class="form-control" tabindex="1">
											<option value="" label="COURSE" selected disabled></option>
											<?php
							...
							<div class="row form-group">
								...
								<div class="col-6 col-md-3">
									  <select data-placeholder="select" class="form-control" name="sem" id="sem" tabindex="1" onChange="showPaper(this.value)">
										<option value="" label="SEMESTER" selected disabled>select</option>
						...
						<div class="row form-group">
								...
								<div class="col-6 col-md-3" id="qpaper">
									 <select data-placeholder="select" class="form-control" tabindex="1" name="qpaper" >
										
									</select>
                        		</div>
						</div>
						<div class="row form-group">
                                        <div class="col col-md-2"><label for="email-input" class=" form-control-label">Year</label></div>
                                        <div class="col-12 col-md-3"><input type="date" id="year" name="year" class="form-control"></div>
                                    </div>
						<div class="row form-group">
                                        <div class="col col-md-2"><label for="file-input" class=" form-control-label">Question Paper</label></div>
                                        <div class="col-12 col-md-3"><input type="file" id="file-input" name="qspaper" class="form-control-file"></div>
                                    </div>			
