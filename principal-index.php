<?php
	...
	if(!isset($_SESSION['tid']))
	{
		...
		$a=$_SESSION['tid'];
		$q="select * from teacherdetails where TID='$a'";
		$res=mysql_query($q);
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/teacher/photo/<?php $res6=mysql_query("select * from teacherdetails where TID=
							'$a'"); $arr6=mysql_fetch_array($res6); echo $arr6['Photo'];?>" alt="User Avatar">
                        </a>
                            ...
                            <div class="card-body">
								<?php
									if($res)
									{
										?>
                                <div class="mx-auto d-block">
                                    <img class="rounded-circle mx-auto d-block" src="images/teacher/photo/<?php $res6=mysql_query("select * from teacherdetails where TID='$a'"); $arr6=mysql_fetch_array($res6); echo $arr6['Photo'];?>" alt="Card image cap">
                                    <h5 class="text-sm-center mt-2 mb-1"><?php echo $arr['Firstname']." ".$arr['Lastname'];?></h5>
