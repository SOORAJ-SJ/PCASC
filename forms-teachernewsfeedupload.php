<?php
	...
	if(!isset($_SESSION['tid']))
	{
		...
		$qn="select * from teacherdetails where TID='$a'";
		$resn=mysql_query($qn);
		$arrn=mysql_fetch_array($resn);
		$deprt=$arrn['FkDID'];
?>
<!doctype html>
                ...
                <ul class="nav navbar-nav">
                   ...
                   <!-- <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">-->
                              <li><a href="tables-studentdetailsview.php"> <i class="menu-icon fa-table"></i> Student Details</a></li>
							<li><a href="tables-studentattendanceview.php"> <i class="menu-icon fa-table"></i> Student Attendance View</a></li>
							<li><a href="tables-internalmarkview.php"> <i class="menu-icon fa-table"></i> Internal Marks</a></li>
							<li></i><a href="tables-teacherleaveview.php"> <i class="menu-icon fa fa-th"></i>Leave View</a></li>
                   <!-- <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Forms</a>
                        <ul class="sub-menu children dropdown-menu">-->
						   ...
						   <li></i><a href="forms-notesupload.php"> <i class="menu-icon fa fa-th"></i>Notes Upload</a></li>
							<li></i><a href="forms-teachernewsfeedupload.php"> <i class="menu-icon fa fa-th"></i>News Feed Upload</a></li>
                       <!-- </ul>
                    </li>
                ...
                <div class="header-menu">
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="message" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<?php
									$qn3=mysql_query("select * from newsfeed");
									while($resn1=mysql_fetch_array($qn3))
									{
									$nid=$resn1['NeID'];
									if($resn1['Expdate']== date('Y-m-d'))
										mysql_query("delete from newsfeed where NeID='$nid'");
									}
								
									$qn3=mysql_query("select * from newsfeed where `To`='teacher' and Department='$deprt' or `To`='all' and Department='0' or `To`='teacher' and Department='0'"); 
									$count=mysql_num_rows($qn3);
									?>
                                <span class="count bg-primary"><?php echo $count; ?></span>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="message">
                                <p class="red">You have <?php echo $count; ?> Notification</p>
								<?php while($resn1=mysql_fetch_array($qn3)){ ?>
                                <a class="dropdown-item media" href="#">
									...
									<div class="message media-body">
                                        ...
                                        <span class="time float-right"><?php echo date('d-m-Y',strtotime ($resn1['Date'])); ?></span>
                                        <p><?php echo $resn1['Notification']; ?></p> 
									</div>	
                                </a>
								<?php } 
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="teacher/photo/<?php $resp=mysql_query("select * from teacherdetails where TID='$a'"); $arrp=mysql_fetch_array($resp); echo $arrp['Photo']; ?>" alt="User Avatar">
                        </a>
...
function showPaper(to) {
  ...
  xmlhttp.open("GET","gettto.php?to="+to,true);
  xmlhttp.send();
}
</script>
                   <div class="col-xs-6 col-sm-12">
                        <div class="card">
							...
							<form action="action-teachernewsfeedupload.php" method="post">
                            <div class="card-body card-block">
									<div class="row form-group">
                                        <div class="col col-md-2"><label for="textarea-input" class=" form-control-label">Notification</label></div>
                                        <div class="col-6 col-md-6"><textarea name="notification" id="textarea-input" rows="4" placeholder="News feed..." class="form-control"></textarea></div>
                                    </div>	
									<div class="row form-group">
									<div class="col col-md-2"><label for="date-input" class=" form-control-label">Expiry Date</label></div>
									<div class="col-6 col-md-6"><input type="date" id="date" name="exdate" class="form-control"></div>
									</div>
									<div class="row form-group">
						...
						<div class="row form-group">
								...
								<div class="col-6 col-md-6" id="dept">
									 <select data-placeholder="select" class="form-control" tabindex="1" name="dept" >
