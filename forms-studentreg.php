...
function showCourse() {
  ...
  xmlhttp.open("GET","getcourse1.php?dept="+dept,true);
  xmlhttp.send();
}
</script>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="action-studentreg.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5"><input type="text" id="text-input" name="fname" placeholder="Enter the Name" class="form-control" required> </div>
									</div>
									 <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Last name</label></div>
                                        <div class="col-12 col-md-5"><input type="text" id="text-input" name="lname" placeholder="Enter the Name" class="form-control" required> </div>
									</div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Date of Birth</label></div>
                                        <div class="col-12 col-md-5"><input type="date" id="dob" name="dob" class="form-control" required></div>
                                    </div>
									<div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5"><input type="text" id="religion" name="religion" placeholder="" class="form-control" required> </div>
									</div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class="form-control-label">Caste</label></div>
                                        <div class="col-12 col-md-5"><input type="text" id="caste" name="caste" placeholder="" class="form-control" required> </div>
									</div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class="form-control-label">Mobile Number</label></div>
                                        <div class="col-12 col-md-5"><input type="tel" id="mob" name="phone" placeholder="" class="form-control" required> </div>
									</div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Email </label></div>
                                        <div class="col-12 col-md-5"><input type="email" id="email-input" name="email" placeholder="Enter Email" class="form-control" required></div>
                                    </div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Address</label></div>
                                        <div class="col-12 col-md-5"><textarea name="address" id="textarea-input" rows="6" placeholder="Address..." class="form-control" required></textarea></div>
                                    </div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Department</label></div>
                                        <div class="col-12 col-md-5" onClick="showCourse(this.value)">
									...
									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5">
                                            <select name="sem" id="select" class="form-control" required>
									...
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Second Language</label></div>
                                        <div class="col-12 col-md-5">
                                            <select name="scndlang" id="select" class="form-control" required>
									...
									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5"><input type="file" id="file-input" name="sslc" class="form-control-file" required></div>
                                    </div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">Plus Two</label></div>
                                        <div class="col-12 col-md-5"><input type="file" id="file-input" name="plustwo" class="form-control-file" required></div>
                                    </div>
									<div class="row form-group">
