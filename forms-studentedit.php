<?php
	...
	if(!isset($_SESSION['tid']))
	{
		...
		$a=$_SESSION['tid'];
		$sid=$_GET['sid'];
		$res=mysql_query("select * from studentdetails where SID='$sid'");
		$arr=mysql_fetch_array($res);
		$res5=mysql_query("select * from course");
	?><!doctype html>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Student Reg.</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                  ...
                  <!--  </div>--><!--/.col-->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="action-studentedit.php?sid=<?php echo $sid; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <!--<div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5"><input type="text" id="text-input" name="fname" value="<?php echo $arr['Firstname'];?>" class="form-control"> </div>
									</div>
									 <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Last name</label></div>
                                        <div class="col-12 col-md-5"><input type="text" id="text-input" name="lname" value="<?php echo $arr['Lastname'];?>" class="form-control"> </div>
									</div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Date of Birth</label></div>
                                        <div class="col-12 col-md-5"><input type="date" id="dob" name="dob" value="<?php echo $arr['Dob']?>" class="form-control"></div>
                                    </div>
									<div class="row form-group">
                                        ...
                                        <div class="col col-md-9">
                                            ...
                                            <div class="form-check-inline form-check">
                                                <label for="inline-radio1" class="form-check-label ">
                                                    <input type="radio" id="inline-radio1" name="gender" value="M" class="form-check-input" checked>Male
                                                </label>&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5"><input type="text" id="religion" name="religion" value="<?php echo $arr['Religion'];?>" class="form-control"> </div>
									</div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class="form-control-label">Caste</label></div>
                                        <div class="col-12 col-md-5"><input type="text" id="caste" name="caste" value="<?php echo $arr['Caste'];?>" class="form-control"> </div>
									</div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class="form-control-label">Mobile Number</label></div>
                                        <div class="col-12 col-md-5"><input type="tel" id="mob" name="phone" value="<?php echo $arr['Phone'];?>" class="form-control"> </div>
									</div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Email </label></div>
                                        <div class="col-12 col-md-5"><input type="email" id="email-input" name="email" value="<?php echo $arr['Email'];?>" class="form-control"></div>
                                    </div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Address</label></div>
                                        <div class="col-12 col-md-5"><textarea name="address" id="textarea-input" rows="6" value="" class="form-control"><?php echo $arr['Address'];?></textarea></div>
                                    </div>
									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5">
											...
											while($arr5=mysql_fetch_array($res5))
											{
												...
												?><option value="<?php echo $arr5['CID']; ?>" <?php if($arr['FkCID']==$arr5['CID']) { echo 'selected';  } ?>><?php echo $arr5['Course'];?></option><?php
											}
                                             ?>
                                            </select>
                                        </div>
									...
									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5">
                                            <select name="scndlang" id="select" class="form-control">
                                                <option value="">Language</option>
												<?php if($arr['Secondlang']=='Hindi')
												{ ?>
